...
class QuranJuzUseful extends StatefulWidget {
  const QuranJuzUseful({super.key});

  @override
  State<QuranJuzUseful> createState() => _QuranJuzUsefulState();
}

class _QuranJuzUsefulState extends State<QuranJuzUseful> {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CustomButtonCancel(
                                onFirstTap: () {
                                  NavigationService
                                      .navigateTo(Routes.juzEnglishTranslationScreen);
                                },
                                onSecondTap: () {
                                  if (isChecked) {
                                    NavigationService
