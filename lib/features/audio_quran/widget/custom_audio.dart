...
class _SurahDetailScreenState extends State<SurahDetailScreen> {
  ...
  void initState() {
    ...
    Map<int, String> surahAudioFiles = {
      0: 'audio/quran_al_fatihah.mp3',
      1: 'audio/quran_al_baqarah.mp3',
      // add more as needed
    };
    audioFile = surahAudioFiles[widget.surahIndex] ?? 'audio/quran_al_fatihah.mp3';
  ...
  void _togglePlayPause() => _isPlaying ? _stopPlayback() : _startPlayback();
  ...
  Widget build(BuildContext context) {
    return Consumer<UiDarkModeController>(builder: (context, controller, child) {
          ...
          decoration: BoxDecoration(
            ...
            image: isStarfield
              ...
              fit: BoxFit.cover,
                ...
                : null,
            gradient: isStarfield || isLight ? null : UiDarkModeHelper.getCurrentGradient(context),
          ),
          child: SafeArea(
            child: Padding(
              ...
              child: Column(
                children: [
                  QuranPlayAppbar(
                    text: widget.surahTitle,
                    subtitle: widget.surahSubtitle,
                    showIcon: false,
                  ...
                  Row(
                    children: [
                      Text(_formatDuration(_currentPosition),
                          style: TextFontStyle.textStyle16w600cFFFFFFRaleway.copyWith(fontWeight: FontWeight.w400, fontSize: 14.sp)),
                      Spacer(),
                  ...
                  Row(
                    ...
                    children: [
                      CircleAvatar(radius: 30, backgroundColor: Colors.transparent, child: SvgPicture.asset(AppIcons.doubleArrow)),
                      CircleAvatar(radius: 25, backgroundColor: isLight ? AppColors.cDCD3C0 : Color(0x26959595), child: SvgPicture.asset(AppIcons.play_back)),
                      GestureDetector(
                      ...
                      CircleAvatar(radius: 25, backgroundColor: isLight ? AppColors.cDCD3C0 : Color(0x26959595), child: SvgPicture.asset(AppIcons.play_right)),
                      CircleAvatar(radius: 30, backgroundColor: Colors.transparent, child: SvgPicture.asset(AppIcons.play_loading)),
                    ],
                  ),
                  Spacer(),
                ],
