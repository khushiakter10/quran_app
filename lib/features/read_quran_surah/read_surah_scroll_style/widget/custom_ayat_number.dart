...
class CustomAyatNumber extends StatefulWidget {
  const CustomAyatNumber({super.key});

  @override
  State<CustomAyatNumber> createState() => _CustomAyatNumberState();
}

class _CustomAyatNumberState extends State<CustomAyatNumber> {
