...
class TafsirSignUpScreen extends StatefulWidget {
  const TafsirSignUpScreen({super.key});

  @override
  State<TafsirSignUpScreen> createState() =>
      _TafsirSignUpScreenState();
}

class _TafsirSignUpScreenState
    extends State<TafsirSignUpScreen> {
